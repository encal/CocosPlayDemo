/**
 目前 QQ浏览器 || QQ空间玩吧 || 猎豹浏览器 || 百度浏览器 暂时需要特殊处理，还不能使用此代码
 游戏纯 H5 模式不需要引入此文件
  */
if (cc.runtime && cc.runtime.config && cc.runtime.config["channel_id"] != "100115"
    ...
    anysdk.UserActionResultCode = {
        ...
        /**< enum value is callback after registering realname. */
        kAccountSwitchSuccess: 15,
        /**< enum alue is callback of succeeding in switching account. */
        ...
        /**< enum value is callback of succeeding in sending to desktop. */
        kSendToDesktopFail: 51002,
        /**< enum value is callback of failing in sending to desktop. */
        kGetAvailableLoginTypeSuccess: 51003,
        /**< enum value is callback of succeeding in getting available login type. */
        kGetAvailableLoginTypeFail: 51004,
        /**< enum value is callback  of failing in getting available login type. */
        kGetUserInfoSuccess: 51005,
        /**< enum value is callback  of succeeding in getting user info.*/
        kGetUserInfoFail: 51006,
        /**< enum value is callback  of failing in getting user info. */
        kOpenBBSSuccess: 51007,
        /**< enum value is callback of succeeding in opening BBS.*/
